...
function addMarker(lat, lon, site, html) {
	...
	nIcon.imageOut  = "http://gce-svn.marsci.uga.edu:8080/exist/rest/db/projects/util/web/js/gce/circle-green.png";
	nIcon.imageOver = "http://gce-svn.marsci.uga.edu:8080/exist/rest/db/projects/util/web/js/gce/circle-orange.png";
...
function mapInitialize()
{
    if (GBrowserIsCompatible()) {
		...
		var centerLatitude = 31.3;
		var centerLongitude = -81.35;		
		var startZoom = 9;
        ...
        var otherOpts = {
          buttonHTML: "<img src='http://gce-svn.marsci.uga.edu:8080/exist/rest/db/projects/util/web/js/gce/zoom-button.gif' />",
          buttonZoomingHTML: "<img src='http://gce-svn.marsci.uga.edu:8080/exist/rest/db/projects/util/web/js/gce/zoom-button-activated.gif' />",
