<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:lter="eml://ecoinformatics.org/lter-project-2.1.0" version="1.0">
  ...
  <xsl:variable name="url_frag_projectDB_xsl">http://amble.lternet.edu:8080/exist/rest/db/projects/util/xslt/sbcProjectDescription.xsl</xsl:variable>
                        ...
                        <table>
                            <tr>
                                ...
                                <th id="project_studyArea_tab" class="defaultTab" style="width:16.6%">
                                    <a href="javascript:showSection('project_studyArea')" title="Display information about the project's study area">Study Area</a>
                                </th>
                              <th id="project_material_tab" class="defaultTab" style="width:16.6%">
                                <a href="javascript:showSection('project_material')" title="Display data products, citations or other material associated with this project">Products</a>
                              </th>
                                ...
                                <th id="project_showall_tab" class="defaultTab" style="width:17%">
                                    <a href="javascript:showAll()" title="Display all the information about this project">Show All</a>
                                </th>
                            </tr>
                            ...
                            <tr id="project_material">
                                <td colspan="6">
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            <h3>Associated Material and Information</h3>
                                            <p class="no-info">
    ...
    <!--   <xsl:param name="url_frag_sbc_people_app" select="$url_frag_sbc_people_app"></xsl:param> -->
        <xsl:if test="individualName[. !='']">
          <xsl:choose>
                <xsl:when test="@id">
               <xsl:variable name="lter_id">
                    <xsl:value-of select="@id"/>
               </xsl:variable>
          <xsl:element name="a">
            <xsl:attribute name="target">_parent</xsl:attribute>
            <xsl:attribute name="href">
              <xsl:value-of select="$url_frag_sbc_people_app"/>
              <xsl:value-of select="$lter_id"/>
            </xsl:attribute>
            <emphasis>
                            <xsl:value-of select="normalize-space(individualName)"/>
            </emphasis>
